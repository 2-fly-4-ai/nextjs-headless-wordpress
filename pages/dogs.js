            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="gap-8 items-center  px-4 mx-auto max-w-screen-2xl xl:gap-8  md:grid md:grid-cols-2  lg:px-6">
                    ...
                    <div class="mt-4 md:mt-0 ">
                        ...
                        <a href="#" className="inline-flex rounded-full items-center justify-center px-5 mr-auto py-3 text-base  text-center text-gray-800 border border-gray-600  hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
