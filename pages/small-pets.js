        ...
        <Layout data={data}>
            ...
            <section class="bg-white dark:bg-gray-900 xl:pt-8">
                <div class="py-8 px-4 mx-auto max-w-screen-2xl sm:py-4 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center">
                        <h2 class="mb-2 text-4xl tracking-tight  leading-tight text-gray-900 dark:text-white ">Small Pets: The Complete Guide to Pet Care</h2>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="gap-8 items-center  px-4 mx-auto max-w-screen-2xl xl:gap-8  md:grid md:grid-cols-2  lg:px-6">
                    <img class="w-full dark:hidden" src="https://images.unsplash.com/photo-1526346093155-a601c2cbe917?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="dashboard image" />
            ...
            <section className="bg-white dark:bg-gray-900 max-w-screen-2xl mx-auto px-6 ">
                <div className="py-8 px-0  mx-auto max-w-screen-2xl sm:py-8 lg:px-0">
                    <div className="mx-auto max-w-screen-2xl text-left">
                        <h2 className="mb-6 text-4xl tracking-tight text-gray-800 dark:text-white">The Small Pet Archives</h2>
                    </div>
                    ...
                    >
                        ...
                        >
                            <div className="grid gap-8 mb-16 lg:divide-x lg:divide-gray-200 dark:lg:divide-gray-700 lg:grid-cols-3">
                                <article>
                                    ...
                                    <p className="mb-4  text-gray-700 dark:text-gray-400">Pugs - The Cutest Small Pets Ever? We explore the gangster-like Small Pets that have taken over social media. These little Small Pets have big personalities, and an even bigger following </p>
                        ...
                        <Tabs.Item title="Small Pets Breeds">
                            Dashboard content
                        </Tabs.Item>
                        <Tabs.Item title="Dog Lifestyle & Fiteness">
                            Settings content
                        </Tabs.Item>
                        <Tabs.Item title="Food For Small Pets & Nutritional Tips">
                            Contacts content
                        </Tabs.Item>
                        <Tabs.Item
                            disabled={true}
