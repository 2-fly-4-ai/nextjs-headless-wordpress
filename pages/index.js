	...
	return (
		...
		<Layout data={data}>
			...
			<section className="bg-white dark:bg-gray-900 ">
					<div className=" grid max-w-screen-2xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0  lg:py-2  lg:grid-cols-12">
						...
						<div className=" lg:col-span-6 w-full	pr-10 flex flex-col my-auto">
							<div className="max-w-screen-xl  py-4 mr-auto text-center lg:py-4 lg:px-2">
								<dl className="grid max-w-screen-md gap-2 sm:gap-8 mx-auto text-gray-900 grid-cols-3 dark:text-white">
									<div className="rounded-lg lg:hover:-translate-y-2 duration-500 flex flex-col items-center justify-center bg-green-400 p-3 shadow-lg">
										<dt className="mb-2 text-3xl md:text-4xl ">73M+</dt>
										<dd className="font-medium text-gray-900 dark:text-gray-400">developers</dd>
								</div>
									<div className="rounded-lg lg:hover:-translate-y-2 duration-500 flex flex-col items-center justify-center bg-yellow-300 p-3 shadow-lg">
										<dt className="mb-2 text-3xl md:text-4xl ">1B+</dt>
										<dd className="font-medium  text-gray-900 dark:text-gray-400">contributors</dd>
								</div>
									<div className="rounded-lg lg:hover:-translate-y-2 duration-500 flex flex-col items-center justify-center bg-red-400 p-3 shadow-lg">
										<dt className="mb-2 text-3xl md:text-4xl ">4M+</dt>
										<dd className="font-medium text-gray-900 dark:text-gray-400">organizations</dd>
								</div>

							</dl>
						</div>
							<h1 className="w-full mb-4 text-4xl  tracking-tight leading-none md:text-5xl lg:text-5xl 2xl:text-6xl dark:text-white">{data?.header?.siteTagLine}</h1>
							<p className="max-w-xl mb-6  text-gray-600 lg:mb-6 md:text-lg lg:text-xl dark:text-gray-400">From checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack. From checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack.</p>

							<a href="#" className="inline-flex rounded-full items-center justify-center px-5 mr-auto py-3 text-lg font-medium text-center text-gray-700 border border-gray-600  hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
							Go to shop
						</a>
					</div>

						<div className="hidden  lg:col-span-5 xl:flex 2xl:h-full overflow-hidden max-h-almost-screen ">
							<img className="object-contain" src="http://staging-petsmarketplace-staging.kinsta.cloud/wp-content/uploads/2022/10/nordwood-themes-Z1-yorzKan8-unsplash-1-scaled-e1666209370624.jpg" alt="mockup" />
					</div>
				</div>
			</section>
				...
				<section className="bg-white bg-no-repeat bg-cover bg-center bg-blend-multiply max-w-screen-2xl mx-auto px-6">
					<div className="relative py-4 2xl:px-0 lg:py-6  lg:px-6 mx-auto text-black  z-1 flex flex-col">
						...
						<div className="grid gap-0 md:gap-4 lg:pt-6 2xl:mt-0 lg:mt-0 md:grid-cols-2 lg:grid-cols-7 ">
							...
							<div className='flex flex-col justify-items-center items-center shadow-lg lg:rounded-full  bg-amber-300 p-2 lg:hover:-translate-y-2 duration-500'>
								<img src="https://i.pinimg.com/736x/26/78/bc/2678bc60b5cd20ed745ae0fba79d23dd.jpg" className='rounded-full max-h-64' />
			...
			<section className="bg-white dark:bg-gray-900 max-w-screen-2xl mx-auto px-6 ">
					...
					<div className="mx-auto max-w-screen-2xl text-left">
							<h2 className="mb-6 text-3xl lg:text-4xl tracking-tight  text-gray-900 dark:text-white">Animal News</h2>
					</div>
					<div className="grid gap-8 mb-16 lg:divide-x lg:divide-gray-200 dark:lg:divide-gray-700 lg:grid-cols-3">
						...
						<div className="space-y-8 lg:pl-8">
							<article>
									...
									<p className="mb-4  text-gray-700 dark:text-gray-400">Over the past year, Volosoft has undergone many changes! After months of preparation and some hard work, we moved to our new office.</p>
								<a href="#" className="inline-flex items-center font-medium text-primary-600 hover:underline dark:text-primary-500">
									Read more
										<svg className="ml-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
								</a>
				...
				<div className="py-8 px-4 mx-auto max-w-screen-2xl lg:py-6 lg:pb-2 lg:px-2 border-yellow-200 border-8">
						<div className="grid gap-6 lg:gap-0  md:grid-cols-3 lg:grid-cols-6 sm:grid-cols-2 justify-center">
							...
							<a href="#">
									<div className="lg:h-44  2xl:max-h-72 flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/71y3R5QvA9L._AC_SL1500_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className=" py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">Noteworthy technology acquisitions 2021</h5>
							</a>
						</div>
						...
						<div className="p-3 pb-3 max-w-sm bg-white rounded-none  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
								<div className="lg:h-44 2xl:max-h-72  flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/61kk7l9BjlL._AC_SL1500_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className="py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">IVEWOODY Tactical Training Adhesion Reflective</h5>
							</a>
						...
						<div className="p-3 pb-3 max-w-sm bg-white rounded-none  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
								<div className="lg:h-44 2xl:max-h-72  flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/61yQxOWs4OL._AC_SL1181_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className=" py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">Aquarium Cleaner Changer Air Pressing Controller</h5>
							</a>
						...
						<div className="p-3 pb-3 max-w-sm bg-white rounded-none  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
								<div className="lg:h-44 2xl:max-h-72 flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/71LtXuEA1sL._AC_SX679_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className=" py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">Earth-Rated-Lavender-Scented-Completely</h5>
							</a>
						...
						<div className="p-3 pb-3 max-w-sm bg-white rounded-none  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
								<div className="lg:h-44 2xl:max-h-72 flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/71ujgHCbdIL._AC_SX679_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className=" py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">GloFish Aquarium Gravel Fluorescent 5 Pound</h5>
							</a>
						...
						<div className="p-3 pb-3 max-w-sm bg-white rounded-none  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
								<div className="lg:h-44 2xl:max-h-72 flex flex-col bg-white">
										<img src="https://m.media-amazon.com/images/I/61s7RbaOCoL._AC_SX679_.jpg" className="m-auto h-56 lg:h-44 2xl:max-h-72" />
								</div>
									<h5 className=" py-3 px-2 font-medium tracking-tight text-gray-900 dark:text-white text-center">Noteworthy technology acquisitions 2021</h5>
							</a>
						</div>
			...
			<section className="bg-white dark:bg-gray-900 px-6">
					...
					<div className="mx-auto max-w-screen-2xl text-left mb-8 lg:mb-8">
							<h2 className="mb-4 text-4xl tracking-tight  text-gray-900 dark:text-white">Best Picks</h2>
					</div>
			...
			<section className="bg-white dark:bg-gray-900 px-6">
					<div className="py-8  mx-auto max-w-screen-2xl lg:py-16 lg:px-0">
					<div className="mx-auto max-w-screen-2xl text-left mb-8 lg:mb-8">
							<h2 className="mb-4 text-4xl tracking-tight  text-gray-900 dark:text-white">Featured Product Reviews</h2>
					</div>
					<div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
						<article className=" bg-white  dark:bg-gray-800 dark:border-gray-700">
							<a href="#">
				...
				<section className="bg-white dark:bg-gray-900 ">
					<div className="grid gap-16 py-8 px-6 mx-auto max-w-screen-2xl lg:grid-cols-2 lg:py-16 lg:px-6">
						<div className="text-gray-700 sm:text-lg dark:text-gray-400">
							<h2 className="mb-4 text-4xl tracking-tight  text-gray-900 dark:text-white">Our people make us great</h2>
							<p className="mb-2 md:text-lg text-gray-700">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value.</p>
							<p className=" md:text-lg mb-2  text-gray-700">I started my pet supplies company because I saw a need for quality products that were also affordable. I started by selling products out of my home and then eventually expanded to an online store. </p><p className=" md:text-lg text-gray-700">I now have a team of employees who help me run the business and we are constantly expanding our inventory to include new and innovative products. We love being able to help pet owners take care of their furry friends and make sure they have everything they need to live happy and healthy lives.</p>
							<p className=" md:text-lg mt-2 text-gray-700">We search for the best products available and offer them at competitive prices so that everyone can afford to take care of their pets. We love being able to help people and their pets and we will continue to grow our business to reach even more pet owners. Thank you for supporting our company!</p>
					</div>
						...
						<div className="flex flex-col items-center pb-8 sm:flex-row">
							...
							<div className="text-center sm:text-left">
								...
								<span className="text-gray-700 dark:text-gray-400">CEO/Co-founder</span>
									<p className="mt-2 mb-4 max-w-sm  text-gray-700 dark:text-gray-400">Bonnie drives the technical strategy of the themesberg platform and brand.</p>
