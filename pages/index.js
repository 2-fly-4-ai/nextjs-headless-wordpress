				...
				<section className="bg-white dark:bg-gray-900 ">
					<div className=" grid max-w-screen-2xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0  lg:py-16  xl:py-24  lg:grid-cols-12">
						...
						<div className=" lg:col-span-6 justify-center flex xl:flex 2xl:h-full  max-h-almost-screen">
							<img className="xl:h-full" src="https://images.unsplash.com/photo-1551730458-be400bef0161?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="mockup" />
						</div>
					</div>
				</section>
