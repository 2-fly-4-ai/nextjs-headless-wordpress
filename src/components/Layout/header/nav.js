...
const Nav = ({ footer, header, headerMenus, slug }) => {
  ...
  return (
    ...
    <header>
      ...
      {/* Level 2 */}
      <nav className="bg-green-700  mx-auto dark:bg-gray-700 dark:border-gray-600 pr-4 flex justify-center py-2 md:py-0">
        <div className="flex max-w-screen-2xl w-full ">
          ...
          <div className="flex items-center mr-auto ml-3  ">
            ...
            <a href={footer?.socialLinks[0]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600">
            ...
            <a href={footer?.socialLinks[1]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600">
            ...
            <a href={footer?.socialLinks[2]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600">
            ...
            <a href={footer?.socialLinks[3]?.iconUrl} className="inline-flex items-center p-2 text-sm font-medium text-white  rounded-none dark:text-gray-400 hover:bg-green-400 dark:hover:bg-gray-600">
          ...
          <div className="ml-auto py-3 px-4 max-w-screen-2xl lg:grid-cols-1 md:px-2 hidden md:grid ">
            ...
            <label htmlFor="search-dropdown" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">Your Email</label>
                <button id="dropdown-button" data-dropdown-toggle="dropdown" className=" rounded-l-full  hidden md:inline-flex flex-shrink-0 z-10 items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-200  dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">All categories <svg className="ml-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
              ...
              <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                ...
                <div className="relative w-full flex">
                  <input type="search" id="search-dropdown" className=" block p-2.5 w-full  z-20 text-sm text-gray-900 bg-gray-50  md:rounded-l-none md:border-l-gray-50 border-l-1 md:border-l-6 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-800 dark:border-l-gray-600  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-primary-500" placeholder="Search anything..." required />
        ...
        <div className="py-3 px-4 mx-auto max-w-screen-xl md:px-6">
          <div className="flex items-center">
            <ul className="flex flex-row mt-0 mr-6 space-x-20 text-sm font-medium">
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase" aria-current="page">Dogs</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Cats</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Birds</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Small Pets</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Fish & Aquatic Pets</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Reptiles & Amphibians</a>
              </li>
              <li>
                <a href="#" className="text-gray-900 dark:text-white hover:underline uppercase">Horses</a>
              </li>
            </ul>
          </div>
        </div>
